...
<head>
    ...
    <title>layersofleather | TermsNcondition</title>
</head>
<body>
    
<h2>Welcome to Layersofleather</h2>
<p>These terms of service outline the rules and regulations for the use of Layersofleather's Website.</p>
<p>Layersofleather is located at:</p>
    <address>
    Dumdum,Kolkata kolkata <br>- West Bengal , India
</address>

<p>By accessing this website we assume you accept these terms of service in full. Do not continue to use 
    Layersofleather's website if you do not accept all of the terms of service stated on this page.</p>
...
<h2>Cookies</h2>
<p>We employ the use of cookies. By using Layersofleather's website you consent to the use of cookies
    in accordance with Layersofleather's privacy policy.</p>
...
<h2>License</h2>
<p>Unless otherwise stated, Layersofleather and/or it's licensors own the intellectual property rights for
    all material on Layersofleather. All intellectual property rights are reserved. You may view and/or print
    pages from layersofleather.com/ for your own personal use subject to restrictions set in these terms of service.</p>
<p>You must not:</p>
<ol>
    <li>Republish material from layersofleather.com/</li>
    <li>Sell, rent or sub-license material from layersofleather.com/</li>
    <li>Reproduce, duplicate or copy material from layersofleather.com/</li>
</ol>
<p>Redistribute content from Layersofleather (unless content is specifically made for redistribution).</p>
...
<ol>
    ...
    <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
        material and data ('Comments') in areas of the website. Layersofleather does not screen, edit, publish
        or review Comments prior to their appearance on the website and Comments do not reflect the views or
        opinions of Layersofleather, its agents or affiliates. Comments reflect the view and opinion of the
        person who posts such view or opinion. To the extent permitted by applicable laws Layersofleather shall
        ...
        website.</li>
    <li>Layersofleather reserves the right to monitor all Comments and to remove any Comments which it considers
    ...
    <li>You hereby grant to <strong>Layersofleather</strong> a non-exclusive royalty-free license to use, reproduce,
...
<p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
    ...
    the visibility associated with the hyperlink outweighs the absence of Layersofleather; and (d) where the
...
<p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
    you must notify us by sending an e-mail to <a href="mailto:prakashjhakk.pj@gmail.com" title="send an email to prakashjhakk.pj@gmail.com">prakashjhakk.pj@gmail.com</a>.
...
<p>No use of Layersofleather's logo or other artwork will be allowed for linking absent a trademark license
    agreement.</p>
<h2>Iframes</h2>
...
<p>To the extent that the website and the information and services on the website are provided free of charge,
    we will not be liable for any loss or damage of any nature.</p><h2>Layers of leather</h2><p>Here you can find a wide variety of leathers products.</p><h2>Credit &amp; Contact Information</h2>
