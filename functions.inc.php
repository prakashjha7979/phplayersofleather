...
function sentInvoice($con,$order_id){
			  ...
			  <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
				<tr>
				  <td class="email-masthead">
					<a href="https://layersofleather.com" class="f-fallback email-masthead_name">
					[Layersofleather]
				  </a>
				  </td>
				</tr>
					  ...
					  <tr>
						<td class="content-cell">
						  <div class="f-fallback">
							...
							<p>Thanks for using Layersofleather. This is an invoice for your recent purchase.</p>
					...
					<table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
					  <tr>
						<td class="content-cell" align="center">
						  <p class="f-fallback sub align-center">&copy; 2021 [Layersofleather]. All rights reserved.</p>
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="prakashjhakk.pj@gmail.com";
	$mail->Password="iamunstoppable@9607";
	$mail->SetFrom("prakashjhakk.pj@gmail.com");
